<html>
	...
	<?php 
		...
		$query="select * from register where handle='$profile'";
	...
	<body bgcolor="yellow">
		<br<br><br><br>
			...
			<?php 
				...
				if($ans==0){ ?>
					<br><br><center><font color="red" size="6" cooperblack">
					<form method="POST" action="home.php">
							<input type="submit" value="HOMEPAGE">
					</form>
					<?php die("Handle Name ($profile) does not exist");
				}
				while($row=mysql_fetch_array($result,MYSQL_ASSOC)){ ?>
				<pre>
				<font size="6">
				<font color="red">User Profile:</font> <?php echo $profile; ?>
	...
	<font  color="blue">Interested Programming languages</font>	:	<?php echo $row['program']; ?>
				...
				<?php } 
				$query="select * from performance where handle='$profile'";
				$result=mysql_query($query);
			?>
	<br><br><br><br>
	<pre>
				<font size="6">
				<u><font color="red">Performance of </font> <?php echo $profile; ?> :</u>
